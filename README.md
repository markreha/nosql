...
4. Docker in the Docker repository for an example Dockefile and run script to run a NodeJS Docker image that is configured with nodemon and a local application share volume (just copy your MongoDB Express application there).
